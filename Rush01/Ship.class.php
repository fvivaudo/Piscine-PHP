...
class Ship
{
	...
	function __construct(Array $args)
	{
		...
		if ($args['PRESET'] == IMPERIAL_FRIGATE1)
		{
			...
			$this->_length = 4;
			$this->_width = 1;
			$this->_pattern = Array(Array('armada/ship/img00_03.jpg', 'armada/ship/img00_02.jpg', 'armada/ship/img00_01.jpg', 'armada/ship/img00_00.jpg'));
			$this->hull = 5;
			$this->_pp = 10;
			$this->_speed = 15;
			$this->_mobility = 4;
		...
		if ($args['PRESET'] == IMPERIAL_FRIGATE2)
		{
			...
			$this->_length = 4;
			$this->_width = 1;
			$this->_pattern = Array(Array("armada/ship/orangeship/img00_03.jpg", "armada/ship/orangeship/img00_02.jpg", "armada/ship/orangeship/img00_01.jpg", "armada/ship/orangeship/img00_00.jpg"));
			$this->hull = 5;
			$this->_pp = 10;
			$this->_speed = 15;
			$this->_mobility = 4;
		...
		if ($args['PRESET'] == IMPERIAL_DESTROYER)
		{
			...
			$this->_length = 3;
			$this->_width = 1;
			$this->_pattern = Array(Array("armada/ship/orangeship3/img00_02.jpg", "armada/ship/orangeship3/img00_01.jpg", "armada/ship/orangeship3/img00_00.jpg"));
			$this->hull = 4;
			$this->_pp = 10;
			$this->_speed = 18;
			$this->_mobility = 3;
		...
		if ($args['PRESET'] == IMPERIAL_CRUISER)
		{
			...
			$this->_length = 7;
			$this->_width = 2;
			$this->_pattern = Array(Array("armada/ship/orangeship2/img00_06.jpg", "armada/ship/orangeship2/img00_05.jpg", "armada/ship/orangeship2/img00_04.jpg", "armada/ship/orangeship2/img00_03.jpg", "armada/ship/orangeship2/img00_02.jpg", "armada/ship/orangeship2/img00_01.jpg", "armada/ship/orangeship2/img00_00.jpg"),
				Array("armada/ship/orangeship2/img01_06.jpg", "armada/ship/orangeship2/img01_05.jpg", "armada/ship/orangeship2/img01_04.jpg", "armada/ship/orangeship2/img01_03.jpg", "armada/ship/orangeship2/img01_02.jpg", "armada/ship/orangeship2/img01_01.jpg", "armada/ship/orangeship2/img01_00.jpg"));
			$this->hull = 8;
			$this->_pp = 12;
			$this->_speed = 10;
			$this->_mobility = 5;
